...
export declare function getWhitelistedCreator(creator: StringPublicKey, storeId?: StringPublicKey): Promise<string | null>;
export declare function getPrizeTrackingTicket(auctionManager: string, mint: string): Promise<string | null>;
export declare function getAuctionWinnerTokenTypeTracker(auctionManager: string): Promise<string | null>;
export declare function getSafetyDepositConfig(auctionManager: string, safetyDeposit: string): Promise<string | null>;
export declare function getStoreIndexer(page: number): Promise<string | null>;
export declare function getAuctionCache(auction: StringPublicKey): Promise<string | null>;
export declare function getPayoutTicket(auctionManager: string, winnerConfigIndex: number | null | undefined, winnerConfigItemIndex: number | null | undefined, creatorIndex: number | null | undefined, safetyDepositBox: string, recipient: string): Promise<string | null>;
